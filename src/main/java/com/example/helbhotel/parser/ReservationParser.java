...
public class ReservationParser extends FileParser {
    ...
    private static final List<String> VALID_TRIP_REASONS = List.of("Tourism", "Business", "Other");  // Raisons de séjour valides
    ...
    private Reservation getReservationRequestFromLineString(String line) {
        ...
        if (!VALID_TRIP_REASONS.contains(motifSejour)) {
            throw new IllegalArgumentException("Invalid trip reason: " + motifSejour + ". Valid reasons are: " + VALID_TRIP_REASONS);
        }
